//! A pure-software [`AudioPlayback`] backend.
//!
...
//! `f32` buffer in [`render`](Software::render).
//!
...
//! call [`render`](Software::render) once over the whole piece. It can equally
//! drive a live device by being fed small blocks from an audio callback (e.g.
//! `rameau_tinyaudio`).
//!
